...
urlpatterns = [
    ...
    re_path(r'^create_generated_password$', create_generated_password,
            name='create_generated_password'),
    path('update_generated_password/<int:pk>',
         update_generated_password, name='update_generated_password'),
    path('delete_generated_password/<int:pk>',
         delete_generated_password, name='delete_generated_password'),
    re_path(r'^generated_passwords$', list_generated_password,
